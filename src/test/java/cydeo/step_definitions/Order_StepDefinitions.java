...
public class Order_StepDefinitions {
    ...
    public void user_is_already_logged_in_and_on_order_page() {
        ...
        cydeo.utilities.Driver.getDriver().get(cydeo.utilities.ConfigurationReader.getProperty("web.table.url"));
...
//    }
    ...
    public void user_selects_credit_card_type(String expectedCardType) {
        ...
        cydeo.utilities.BrowserUtils.clickRadioButton(orderPage.cardType, expectedCardType);
